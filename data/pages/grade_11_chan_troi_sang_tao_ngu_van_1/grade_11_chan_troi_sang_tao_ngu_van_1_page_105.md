Ví dụ: Một học sinh thường đến thư viện trường để đọc sách, tìm sách bao nhiêu lần trong một tháng? Nguyên nhân của thực trạng và giải pháp khuyến khích học sinh đọc sách là gì?
...
• Dựa trên các tài liệu đã đọc, viết nhập cơ sở lí thuyết để xác lập căn cứ cho việc khảo sát thực trạng hoặc thực nghiệm giải pháp nào đó nhằm cải thiện thực trạng.
...
Để xác định đúng, đủ các dữ liệu cần thu thập, bạn cần trả lời các câu hỏi:
