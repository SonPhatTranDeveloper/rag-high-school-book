...
[Hình ảnh có chú thích nhỏ ở góc dưới bên trái: "Kích hoạt để mở học liệu điện tử: Các bạn nhấn vào đây để nhận mã số. Truy cập http://hanhtrangso.nxbgd.vn và nhập mã số để trải nghiệm thử khóa."]

[Ở góc dưới bên phải có dòng chữ: "Giá: ... đ"]